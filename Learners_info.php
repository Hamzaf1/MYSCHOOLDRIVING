                            ...
                            <div class="container-fluid">
                                ...
                                <form action="Learners_info.php?Learners_id=<?php echo $selected_Learners ?> & Learnersuser_id=<?php echo $Luser ?>" method="post" class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-2" for="email">l'Age:</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="email" placeholder="Age" name="userage" required>
                                            </div>
                                        </div>
										 <div class="form-group">
                                            <label class="control-label col-sm-2" for="email">Numéro de téléphone:</label>
                                            <div class="col-sm-10">
  ...
  if(	mysqli_query($connection,$insert))
{
    ...
    echo "<script>alert('Votre réservation a été effectuée avec succès et nous vous contacterons bientôt. Merci !......')</script>";
...
?>
                ...
                <div class="well">
                    ...
                    <form action="Learners_info.php?Learners_id=<?php echo $selected_Learners ?>" method="post" role="form">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit_query">Envoyer</button>
                    </form>
                </div>
