 ...
 <?php include "db.php"; ?>
		...
		<select name="City" id='city_select' class="form-control">
	     <option value='' selected='selected' hidden='hidden'>ville</option>
			<?php 
		...
		echo "<option class='$nameofdistic' value='$id_name'>$id_name</option>";
           ...
           <button class="btn btn-primary" name="submit" style="margin-left: 130px; margin-top: 10px;">Recherche</button>
