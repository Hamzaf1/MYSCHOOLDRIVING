                                ...
                                <tbody>
									...
									<?php 
								     ...
								     ?>
                                        ...
                                        <?php echo "<td><a href='Bookings.php?deleteuser=$order_id'>Suprimer</a></td>"; ?>
                                       
                                        <?php echo "<td><a href='Bookings.php?Confirm=$order_id'>Comfirmer</a></td>"; ?>
                                        <?php echo "<td><a href='Bookings.php?remove_from_Confirm=$order_id'>Supprimer de la confirmation</a></td>"; ?>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                                </table>
